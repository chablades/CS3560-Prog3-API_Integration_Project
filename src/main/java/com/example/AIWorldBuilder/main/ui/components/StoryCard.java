package com.example.AIWorldBuilder.main.ui.components;
...
public class StoryCard extends JPanel {
    ...
    public StoryCard(Story story, MainControllerInterface controller) {
        this.story = story;
        ...
        mainPanel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                controller.onOpenStoryEditor(story);
            }
        });
        ...
        // Title label
        titleLabel = new JLabel(story.getTitle());
        ...
        deleteBtn.addActionListener(e -> {
            ...
            boolean confirmed = confirmDialog.showDialog(
                "Are you sure you want to delete the story \"" + story.getTitle() + "\"?",
                "Confirm Delete"
            );
            if (confirmed) {
    ...
    // Revalidate card (e.g., after story update)
    public void updateCard(Story s) {

        this.story = s;
        // Update UI components with new story data
